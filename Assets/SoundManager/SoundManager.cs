...
public class SoundManager : MonoBehaviour
{
    ...
    static string[] music_names = new string[]
    {
        "music_background",
        "music_background2",
        "music_background3",
    ...
    {
        int v = UnityEngine.Random.Range(0, music_names.Length - 1);
        string name = music_names[v];
        myUtils.console_log("mus=", v, name);
        PlayMusic(name); // "music_background2");
    }
